...
export default function GeneralPage(){
    return(
        <>
            <header className="shadow-md flex justify-between p-6">
                <h1>TALENVO</h1>
...
<section className="bg-blue-500 text-center p-1 rounded px-2">
    <p>Book Appointment</p>
            ...
            <section className="md:h-4/5 md:flex-col md:justify-between md:flex">
    <section className="md:h-91/100 md:fixed md:top-20 md:left-0 md:flex md:flex-col md:ml-0 shadow-lg">
        {/* Navigation Items */}
        ...
        {/* Profile SVG Positioned at the Bottom */}
        <section className="mt-auto flex justify-center py-4">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
